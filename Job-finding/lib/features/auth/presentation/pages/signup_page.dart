...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _onSignUp() {
    context.read<AuthBloc>().add(
          SignUpRequested(_fullNameController.text, _emailController.text, _passwordController.text),
        );
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField('Full name', _fullNameController, false, null),
                  ...
                  Row(
                     ...
                     children: [
                       const Text("You already have an account? ", style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                       GestureDetector(
                         onTap: () => context.go('/login'),
                         child: const Text('Log in', style: TextStyle(fontSize: 12, color: AppColors.secondary, fontWeight: FontWeight.bold, decoration: TextDecoration.underline)),
                       )
                     ],
                  )
                ],
